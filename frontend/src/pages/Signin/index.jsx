        ...
        <div className="container">
            <div className="card">
                ...
                <div className="socialLogin">
                    <button className="google" onClick={handleGoogleSingIn} disabled={loading} aria-label='entrar com Google'>
                        <FcGoogle size={24}/>
                    </button>
                ...
                {user && (
                    <div className='userInfo' style={{marginTop: 16}}>
                        <img src={user.photoURL} alt={user.name} style={{width: 40, borderRadius: '50%'}} />
                        <div>
                            <p>
